...
import {type IUser, useAuthentication} from "../../../authentication/contexts/AuthenticationContextProvider";
    ...
    const like = async () => {
        await request<void>({
            ...
            onSuccess: () => {
                ...
                if (postLiked) {
                    setLikes((prev) => prev.filter((u) => u.id !== user.id));
                } else {
        ...
        <>
            ...
            <div className={classes.root}>
                    ...
                    <div className={classes.author}>
                        ...
                        <div>
                            ...
                            <TimeAgo
                                ...
                                edited={post.creationDate !== post.updatedDate}
                ...
                <div className={classes.stats}>
                    {(likes.length > 0) ? (<div className={classes.stat}>
                            <span>{postLiked ? "You " : likes[0].firstName + " " + likes[0].lastName + " "}</span>
                            {likes.length - 1 > 0 ? (
                                <span>and {likes.length - 1} {likes.length - 1 === 1 ? "other" : "others"}</span>
                            ) : null}
                            liked this
                        </div>
                    ) : <div></div>}
